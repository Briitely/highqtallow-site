...
import mapleLeafSvg from '../assets/Tallow_Balm_Front_Labels.svg';
  ...
  return (
    <footer id="contact" className="bg-midnight pt-10 pb-6 relative">
      <div className="max-w-7xl mx-auto px-6 relative">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-16 pb-8 border-b border-white/10 lg:items-end lg:justify-items-center">
          ...
          <div className="flex flex-col items-center justify-end text-center lg:items-center lg:text-center">
            <div className="flex items-center justify-center gap-3 mb-2">
              <img src={mapleLeafSvg} alt="" className="w-5 h-5 flex-shrink-0" aria-hidden="true" />
