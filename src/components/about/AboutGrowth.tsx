      ...
      <div className="max-w-6xl mx-auto px-6">
        <div ref={ref1} className="scroll-reveal mb-12">
          <p className="font-body text-xs font-semibold uppercase tracking-[0.2em] text-olive-earth/60 mb-4 max-w-3xl mx-auto">
            From Experiments to <span className="whitespace-nowrap">High Q<span className="text-[0.6em] align-super font-semibold tracking-tight leading-none">&trade;</span></span>
          </p>
